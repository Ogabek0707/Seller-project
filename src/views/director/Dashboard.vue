<template>
      <div class="dash">
            ...
            <section class="dashboard_charts">
                  <BarChart :expense_total="expense_total" :income_total="income_total"/>
            </section>
...
let income_total = ref({})
let expense_total = ref({})
let params = ref({
      page: 1,
      per_page: 10,
      last_page: null,
...
const getAnnualy = () => {
      http.get('dashboard/annual-profit/').then(res=>{
            ...
            expense_total.value = total_expense
            income_total.value = total_income
            console.log(expense_total.value, "Ex");
            console.log(income_total.value, "In");
      })
}
getAnnualy()
getTopClient()
